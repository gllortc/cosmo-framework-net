...
namespace Cosmo.Cms.Photos
{
   ...
   public class Photo : IPublishable
   {
      ...
      /// <summary>
      /// Devuelve una instancia de <see cref="Photo"/>.
      /// </summary>
      public Photo()
      {
         Initialize();
      ...
      /// <summary>
      /// Devuelve o establece la descripción de la imagen (puede contener tags HTML sólo a nivel de formato o cambio de línea).
      /// </summary>
