...
namespace Cosmo.Cms.Web
{
   ...
   [ViewParameter(ParameterName = Cosmo.Workspace.PARAM_OBJECT_ID,
                  PropertyName = "AdID")]
   public class AdsUnpublishModal : ModalView
   {
      // Modal element unique identifier 
      private const string DOM_ID = "ads-unpublish-modal";
      ...
      {
         Title = "Despublicar anuncio clasificado";
         Icon = IconControl.ICON_DELETE;
         Closeable = true;

         FormControl form = new FormControl(this, "frmAdUnpublish");
         form.UsePanel = false;
         ...
         confirm.AppendParagraph("¿Está seguro/a que desea despublicar el anuncio clasificado?");
      ...
      public override void FormDataReceived(FormControl receivedForm)
      {
         ...
         try
         {
            ...
            else
            {
               ...
               callout.Text = "Usted no es el autor del anuncio que está tratando de despublicar. " +
