...
namespace Cosmo.Cms.REST
{
   ...
   public class CmsApi : RestHandler
   {
      ...
      // public const string URL_REST_SERVICE = "CmsApi";

      /// <summary>Comando para mover un hilo a otro canal.</summary>
      public const string COMMAND_FORUM_THREAD_MOVE = "ftm";
      /// <summary>Comando para eliminar un hilo.</summary>
      public const string COMMAND_FORUM_THREAD_REMOVE = "ftr";
      /// <summary>Comando para cerrar/reactivar un hilo.</summary>
