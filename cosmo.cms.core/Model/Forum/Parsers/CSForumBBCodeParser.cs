...
namespace Cosmo.Cms.Forums.Parsers
{
   ...
   /// </remarks>
   public class CSForumBBCodeParser
   {
      ...
      public static string Parse(string content)
      {
         ...
         // Images   
         content = MatchReplace(@"\[img(?:\s*)\]((.|\n)*?)\[/img(?:\s*)\]", "<img class=\"" + CSForumBBCodeParser.IMG_CLASS + "\" src=\"$1\" border=\"0\" alt=\"Imagen externa\" />", content);
         content = MatchReplace(@"\[img align=((.|\n)*?)(?:\s*)\]((.|\n)*?)\[/img(?:\s*)\]", "<img class=\"" + CSForumBBCodeParser.IMG_CLASS + "\" src=\"$3\" border=\"0\" align=\"$1\" alt=\"Imagen externa\" />", content);
         content = MatchReplace(@"\[img=((.|\n)*?)x((.|\n)*?)(?:\s*)\]((.|\n)*?)\[/img(?:\s*)\]", "<img class=\"" + CSForumBBCodeParser.IMG_CLASS + "\" width=\"$1\" height=\"$3\" src=\"$5\" border=\"0\" alt=\"Imagen externa\" />", content);
