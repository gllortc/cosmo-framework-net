...
namespace Cosmo.Cms.Forums.Model.Obsolete
{
   ...
   public class CSForumThread
   {
      ...
      private List<CSForumMessage> _messages;

      public CSForumThread()
      {
         _threadId = 0;
         _forumId = 0;
         _title = string.Empty;
         ...
         _messages = new List<CSForumMessage>();
      }
      ...
      /// </summary>
      public List<CSForumMessage> Messages
      {
