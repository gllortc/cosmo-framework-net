...
namespace Cosmo.Utils.Html
{
   ...
   {
      private CodeKicker.BBCode.BBCodeParser bbParser = null;
      ...
      public static string FORMAT_LONGDATE = "dddd, d \"de\" MMMM \"de\" yyyy";
      ...
      public string bbCodeParser(string bbCodeText)
      {
