...
namespace Cosmo.Utils.Drawing
{
   ...
   /// </summary>
   internal class DrawingInteropGdi
   {
      /// <summary>
      ...
      public enum BMP_Compression_Modes 
      { 
         BI_RGB = 0, 
         BI_RLE8 = 1, 
         BI_RLE4 = 2, 
      ...
      public struct COLORREF
      {
         ...
         {
            return System.Drawing.Color.FromArgb((int)(0x000000FFU & ColorDWORD), (int)(0x0000FF00U & ColorDWORD) >> 8, (int)(0x00FF0000U & ColorDWORD) >> 16);
         }
