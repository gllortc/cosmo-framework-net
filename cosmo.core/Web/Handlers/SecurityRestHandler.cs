...
namespace Cosmo.Web.Handlers
{
   ...
   public class SecurityRestHandler : RestHandler
   {
      ...
      /// <summary>
      /// Generate a valid URL to call the <c>SecurityRestHandler.UserData</c> method.
      /// </summary>
      ...
      private void UserMailVerification()
      {
         try
         {
            ...
            Workspace.Logger.Security("Suscripción verificada de " + user.Login + " desde " + Request.ServerVariables["REMOTE_ADDR"]);
